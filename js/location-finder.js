/* ============================================================
   ...
   Powers the Google Maps "Locator Plus" store locator used on
   pages/locations.html (and ready to drop into WordPress).

   The locations are hard-coded below for now. When the site moves
   to the data-driven WordPress model (see ROADMAP.md §3–4), this
   list is replaced by data pulled from the Locations CPT.

   Built with Google Maps Platform "Quick Builder" + the Extended
   Component Library <gmpx-store-locator> component:
