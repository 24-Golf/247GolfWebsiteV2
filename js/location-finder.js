/* ============================================================
   ...
   The CONFIGURATION object is kept in the Quick Builder shape so the
   same data can still be pasted into the WordPress store-locator embed
   (see docs/location-finder-wordpress.md) and regenerated by Quick
   Builder. When the site moves to the data-driven WordPress model
